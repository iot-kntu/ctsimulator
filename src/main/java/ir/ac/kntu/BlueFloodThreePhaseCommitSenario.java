...
public class BlueFloodThreePhaseCommitSenario implements SimulationScenario<BlueFloodApplication> {

    private static final int BLUEFLOOD_REPEAT_SLOTS = 3;
    private static final int EXECUTION_ROUNDS = 12;
    private static final double LOSS_PROBABILITY = 0.0;
    private static final Logger logger = Logger.getLogger(BlueFloodThreePhaseCommitSenario.class.getSimpleName());

    private NetGraph netGraph;

    public static void main(String[] args) {
        ScenarioRunner.run(new BlueFloodThreePhaseCommitSenario());
    }
    ...
    public void configure(NetGraph netGraph, BlueFloodApplication application) {
        ...
        application.configureScenarioMetadata("BlueFlood 3PC", "ctsimulator", "Three phase commit over BlueFlood");
