...
public class BlueFloodPaxosSenario implements SimulationScenario<BlueFloodApplication> {

    private static final int BLUEFLOOD_REPEAT_SLOTS = 3;
    private static final int EXECUTION_ROUNDS = 10;
    private static final double LOSS_PROBABILITY = 0.0;
    private static final Logger logger = Logger.getLogger(BlueFloodPaxosSenario.class.getSimpleName());

    private NetGraph netGraph;

    public static void main(String[] args) {
        ScenarioRunner.run(new BlueFloodPaxosSenario());
    }
    ...
    public void configure(NetGraph netGraph, BlueFloodApplication application) {
        ...
        application.configureScenarioMetadata("BlueFlood Paxos", "ctsimulator", "Paxos-like majority commit over BlueFlood");
