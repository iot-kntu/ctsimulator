 ...
 * within a round
 */
public final class CtMessage<T> {

    public static CtMessage NULL_MESSAGE = new CtMessage<>(CtNode.NULL_NODE, 0, null);
     ...
     * @param content
     */
    public CtMessage(CtNode initiator, T content) {
        this.initiator = initiator;
        this.messageNo = ++MessageNoGen;
        this.content = content;
    }

    private CtMessage(CtNode initiator, int messageNo, T content) {
        this.initiator = initiator;
