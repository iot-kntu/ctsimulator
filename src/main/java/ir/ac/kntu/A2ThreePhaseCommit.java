...
public class A2ThreePhaseCommit {
    public static void main(String[] args) {
        try {
            ...
            ChaosTransmissionPolicy transmissionPolicy = new ThreePcTransmissionPolicy(floodRepeatSlots,
            ...
            netGraph.getNodes().forEach(node -> {
                ...
                chaosApplication.setListener(node, new ThreePhaseCommit(proposals, votes));
            });
