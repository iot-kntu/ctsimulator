...
public class A2TwoPhaseCommit implements SimulationScenario<ChaosApplication> {
    ...
    public static void main(String[] args) {
        ScenarioRunner.run(new A2TwoPhaseCommit());
    }
    ...
    public ChaosApplication createApplication(NetGraph netGraph) {
        ...
        ChaosTransmissionPolicy transmissionPolicy = new TwoPcTransmissionPolicy(
                FLOOD_REPEAT_SLOTS,
